    ...
    <Layout>
      <div className="mt-12">
        <section className="mb-12">
          <h2 className="text-2xl font-bold mb-6 text-gray-800">Today Print</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold mb-6 text-gray-800">Print Sum</h2>
          <div className="flex flex-wrap">
            <DashboardCard
        ...
        <section>
          <h2 className="text-2xl font-bold mb-6 text-gray-800">Total Print</h2>
